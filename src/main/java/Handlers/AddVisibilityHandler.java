...
public class AddVisibilityHandler implements Handler{
    @Override
    public SimpleResponse<Object> handle(Request requestObject, Response responseObject) {
        ...
        try {
            ...
            boolean result = AccessListRepository.getInstance().setVisibility(userVisibilty.UserId1, userVisibilty.UserId2);
